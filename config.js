...
const DEFAULT_COURSE_URL = 'https://sysks.cau.edu.cn/students/courseDetail?graphId=2085636525399465985&id=1818526001179570178';
const COURSE_URL = process.env.COURSE_URL || DEFAULT_COURSE_URL;
...
const config = {
  ...
  COURSE_URL,
  GRAPH_ID: process.env.GRAPH_ID || (graphMatch && graphMatch[1]) || '',
